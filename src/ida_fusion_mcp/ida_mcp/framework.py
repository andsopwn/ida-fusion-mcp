...
def test(*, binary: str = "", skip: bool = False) -> Callable:
    ...
    def decorator(func: Callable) -> Callable:
        ...
        # e.g., "ida_fusion_mcp.ida_mcp.api_core" -> "api_core"
        # e.g., "ida_fusion_mcp.ida_mcp.tests.test_api_core" -> "api_core"
...
def run_tests(
    ...
    if verbose:
        print("=" * 80)
        print("ida-fusion-mcp Test Runner")
        print("=" * 80)
        print()
